...
class GraphBuilderService:
    ...
    CONCEPT_CATEGORIES = {
        ...
        'OPPORTUNITY': ['growth', 'opportunity', 'expansion', 'innovation', 'potential'],
        'TECHNOLOGY': ['ai', 'cloud', 'platform', 'saas', 'endpoint', 'zero trust', 'xdr'],
    ...
    def build_graph_for_ticker(self, ticker: str,
                               include_entities: bool = True,
                               include_concepts: bool = True,
                               include_key_phrases: bool = True) -> Dict:
        """
        ...
        try:
            ...
            for artifact in artifacts:
                try:
                    ...
                    results['relationships_created'] += doc_results.get('relationships', 0)

                except Exception as e:
                    logger.error(f"Error processing document {artifact.get('s3_key')}: {e}")
    ...
    def _process_document(self, artifact: Dict,
                          include_entities: bool = True,
                          include_concepts: bool = True,
                          include_key_phrases: bool = True) -> Dict:
        """
        ...
        if include_entities and analysis.get('entities'):
            entity_count = self._process_entities(
                doc_id, ticker, analysis['entities']
            )
    ...
    def _create_document_node(self, doc_id: str, ticker: str,
                              doc_type: str, s3_key: str,
                              published_date: Any):
    ...
    def _process_entities(self, doc_id: str, ticker: str,
    ...
    def _process_key_phrases(self, doc_id: str, ticker: str,
                             key_phrases: List[Dict]) -> int:
        """
