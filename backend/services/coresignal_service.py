...
CORESIGNAL_COMPANIES = {
    ...
    'PANW': {'id': 7898996, 'name': 'Palo Alto Networks', 'domain': 'paloaltonetworks.com'},
...
CACHED_JOBS_BY_FUNCTION = {
    'CRWD': {
        'Engineering': 518, 'Sales and Business Development': 213, 'Information Technology': 768,
        'Marketing': 36, 'Finance': 13, 'Human Resources': 8,
        'Product Management': 21, 'Research': 8, 'Legal': 8,
        'Operations': 0, 'Customer Success and Support': 0, 'Administrative': 1, 'Quality Assurance': 1
    },
    'ZS': {
        'Engineering': 103, 'Sales and Business Development': 104, 'Information Technology': 157,
        'Marketing': 17, 'Finance': 15, 'Human Resources': 10,
        'Product Management': 9, 'Research': 4, 'Legal': 3,
        'Operations': 0, 'Customer Success and Support': 0, 'Administrative': 0, 'Quality Assurance': 0
    },
    'NET': {
        'Engineering': 336, 'Sales and Business Development': 141, 'Information Technology': 297,
        'Marketing': 88, 'Finance': 16, 'Human Resources': 8,
        'Product Management': 59, 'Research': 0, 'Legal': 14,
        'Operations': 0, 'Customer Success and Support': 0, 'Administrative': 3, 'Quality Assurance': 0
    },
    'PANW': {
        'Engineering': 253, 'Sales and Business Development': 0, 'Information Technology': 70,
        'Marketing': 25, 'Finance': 15, 'Human Resources': 9,
        'Product Management': 41, 'Research': 1, 'Legal': 0,
        'Operations': 0, 'Customer Success and Support': 0, 'Administrative': 3, 'Quality Assurance': 0
    },
    'FTNT': {
        'Engineering': 141, 'Sales and Business Development': 351, 'Information Technology': 376,
        'Marketing': 12, 'Finance': 3, 'Human Resources': 11,
        'Product Management': 2, 'Research': 1, 'Legal': 1,
        'Operations': 0, 'Customer Success and Support': 0, 'Administrative': 1, 'Quality Assurance': 17
    },
    'OKTA': {
        'Engineering': 112, 'Sales and Business Development': 66, 'Information Technology': 140,
        'Marketing': 30, 'Finance': 17, 'Human Resources': 2,
        'Product Management': 30, 'Research': 1, 'Legal': 3,
        'Operations': 0, 'Customer Success and Support': 0, 'Administrative': 3, 'Quality Assurance': 0
    },
    'S': {
        'Engineering': 111, 'Sales and Business Development': 36, 'Information Technology': 164,
        'Marketing': 17, 'Finance': 1, 'Human Resources': 1,
        'Product Management': 6, 'Research': 0, 'Legal': 1,
        'Operations': 0, 'Customer Success and Support': 0, 'Administrative': 1, 'Quality Assurance': 0
    },
    'CYBR': {
        'Engineering': 0, 'Sales and Business Development': 0, 'Information Technology': 149,
        'Marketing': 0, 'Finance': 0, 'Human Resources': 0,
        'Product Management': 0, 'Research': 0, 'Legal': 0,
        'Operations': 0, 'Customer Success and Support': 0, 'Administrative': 0, 'Quality Assurance': 0
    },
    'TENB': {
        'Engineering': 27, 'Sales and Business Development': 23, 'Information Technology': 37,
        'Marketing': 6, 'Finance': 1, 'Human Resources': 1,
        'Product Management': 2, 'Research': 1, 'Legal': 0,
        'Operations': 0, 'Customer Success and Support': 0, 'Administrative': 0, 'Quality Assurance': 0
    },
    'SPLK': {
        'Engineering': 49, 'Sales and Business Development': 39, 'Information Technology': 77,
        'Marketing': 15, 'Finance': 0, 'Human Resources': 0,
        'Product Management': 6, 'Research': 4, 'Legal': 0,
        'Operations': 0, 'Customer Success and Support': 0, 'Administrative': 4, 'Quality Assurance': 0
    },
}
...
CACHED_JOBS_BY_SENIORITY = {
    'CRWD': {
        'Entry level': 65, 'Associate': 33, 'Mid-Senior level': 932,
        'Director': 47, 'Executive': 2, 'Not Applicable': 5
    },
    'ZS': {
        'Entry level': 11, 'Associate': 0, 'Mid-Senior level': 273,
        'Director': 28, 'Executive': 1, 'Not Applicable': 1
    },
    'NET': {
        'Entry level': 28, 'Associate': 232, 'Mid-Senior level': 527,
        'Director': 24, 'Executive': 10, 'Not Applicable': 1
    },
    'PANW': {
        'Entry level': 4, 'Associate': 677, 'Mid-Senior level': 312,
        'Director': 49, 'Executive': 0, 'Not Applicable': 31
    },
    'FTNT': {
        'Entry level': 150, 'Associate': 0, 'Mid-Senior level': 657,
        'Director': 27, 'Executive': 0, 'Not Applicable': 5
    },
    'OKTA': {
        'Entry level': 0, 'Associate': 0, 'Mid-Senior level': 4,
        'Director': 0, 'Executive': 0, 'Not Applicable': 337
    },
    'S': {
        'Entry level': 0, 'Associate': 0, 'Mid-Senior level': 2,
        'Director': 1, 'Executive': 0, 'Not Applicable': 231
    },
    'CYBR': {
        'Entry level': 1, 'Associate': 0, 'Mid-Senior level': 164,
        'Director': 0, 'Executive': 0, 'Not Applicable': 1
    },
    'TENB': {
        'Entry level': 8, 'Associate': 1, 'Mid-Senior level': 58,
        'Director': 2, 'Executive': 0, 'Not Applicable': 0
    },
    'SPLK': {
        'Entry level': 0, 'Associate': 0, 'Mid-Senior level': 0,
        'Director': 0, 'Executive': 0, 'Not Applicable': 161
    },
}
...
class CoreSignalService:
    ...
    def store_headcount(self, ticker: str, snapshot_date: str, employee_count: int,
                        by_department: Dict = None, by_country: Dict = None,
                        by_seniority: Dict = None, by_region: Dict = None) -> bool:
        """
    ...
    def store_jobs_snapshot(self, ticker: str, snapshot_date: str,
                            jobs_by_function: Dict, jobs_by_seniority: Dict,
                            employee_count: int = None) -> bool:
        """
        ...
        if not conn:
            ...
            if ticker in CACHED_JOBS_BY_FUNCTION:
                ...
                return {
                    ...
                    'hiring_intensity': round((total / emp_count) * 100, 2) if emp_count else None,
                    'from_cache': True
                }
            return None
    ...
    def get_comparison_data(self, tickers: List[str]) -> Dict[str, Any]:
        ...
        for ticker in tickers:
            ...
            companies[ticker] = {
                ...
                'employee_count': jobs.get('employee_count') if jobs else CACHED_EMPLOYEE_COUNTS.get(ticker),
        ...
        for record in headcount_history:
            ...
            for ticker in tickers:
                if ticker in record and ticker in base_values and base_values[ticker] > 0:
                    index_record[ticker] = round((record[ticker] / base_values[ticker]) * 100, 1)
    ...
    def _generate_insights(self, companies: Dict, hiring_intensity: Dict) -> List[str]:
        ...
        if overall:
            ...
            insights.append(f"{companies[max_ticker]['name']}: Highest hiring intensity ({max_val}%)")
        ...
        if it_eng:
            ...
            insights.append(f"{companies[max_ticker]['name']}: Heaviest IT/Engineering focus ({round(it_eng[max_ticker], 1)}%)")
        ...
        if sales:
            ...
            insights.append(f"{companies[max_ticker]['name']}: Highest sales hiring ({max_val}%)")
    ...
    def search_jobs(self, company_id: int, filters: List[Dict] = None) -> Optional[Dict]:
        """
    ...
    def import_from_json_file(self, filepath: str, ticker: str) -> Dict[str, int]:
        ...
        ticker = ticker.upper()
        counts = {'headcount': 0, 'by_department': 0, 'by_country': 0, 'by_seniority': 0}
        ...
        for record in dept_records:
            ...
            if by_dept:
                self._update_headcount_breakdown(ticker, snapshot_date, by_department=by_dept)
        ...
        for record in country_records:
            ...
            for item in countries:
                by_country[item.get('country', 'Unknown')] = item.get('employee_count', 0)

            if by_country:
                self._update_headcount_breakdown(ticker, snapshot_date, by_country=by_country)
                counts['by_country'] += 1

        # Import seniority breakdown by month
        seniority_records = data.get('employees_count_breakdown_by_seniority_by_month', [])
        for record in seniority_records:
            ...
            if by_seniority:
                self._update_headcount_breakdown(ticker, snapshot_date, by_seniority=by_seniority)
                counts['by_seniority'] += 1

        print(f"✅ Imported {ticker} from {filepath}: {counts}")
        return counts

    def _update_headcount_breakdown(self, ticker: str, snapshot_date: str,
                                     by_department: Dict = None, by_country: Dict = None,
                                     by_seniority: Dict = None, by_region: Dict = None) -> bool:
        ...
        try:
            ...
            if by_department:
                updates.append("by_department = COALESCE(by_department, '{}'::jsonb) || %s")
                values.append(Json(by_department))
            if by_country:
                updates.append("by_country = COALESCE(by_country, '{}'::jsonb) || %s")
                values.append(Json(by_country))
            if by_seniority:
                updates.append("by_seniority = COALESCE(by_seniority, '{}'::jsonb) || %s")
