...
class CyberRiskReturnModel:
    ...
    def get_news_features(self, ticker):
        ...
        return pd.DataFrame([{
            ...
            'negative_news_ratio': negative_count / len(articles) if articles else 0
        }], index=[ticker])
    ...
    def train(self, tickers=['MSFT', 'GOOGL', 'AAPL', 'AMZN', 'META']):
        ...
        # Features and target
        feature_cols = [
            'returns_7d', 'returns_30d', 'volatility_30d', 'rsi',
            'cyber_mentions', 'breach_mentions', 'risk_entity_count',
            'sec_sentiment_negative', 'call_sentiment_score',
            'news_volume_30d', 'negative_news_ratio'
        ]
    ...
    def predict_return(self, ticker):
        ...
        return {
            ...
            'recommendation': self.get_recommendation(predicted_return, current_volatility)
        }
