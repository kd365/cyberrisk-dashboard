...
class CyberRiskForecaster:
    ...
    def add_cybersecurity_sentiment(self, mock=True):
        ...
        print(f"   Range: {self.data['cyber_sentiment'].min():.3f} to {self.data['cyber_sentiment'].max():.3f}")
    ...
    def forecast(self, days_ahead=30):
        ...
        print(f"   Confidence Interval: ${forecast['yhat_lower'].iloc[-1]:.2f} - ${forecast['yhat_upper'].iloc[-1]:.2f}")
